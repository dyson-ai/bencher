...
def example_custom_sweep(run_cfg: bch.BenchRunCfg= bch.BenchRunCfg(),report:bch.BenchReport = bch.BenchReport()) -> bch.Bench:
    ...
    bencher = bch.Bench("benchmarking_example_custom_sweep", Square(), run_cfg=run_cfg,report=report)
