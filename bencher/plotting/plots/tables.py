...
class Tables:
    ...
    def dataframe_flat(self, pl_in: PlotInput) -> pn.panel:
        ...
        df = pl_in.bench_res.get_dataframe()
    ...
    def dataframe_multi_index(self, pl_in: PlotInput) -> pn.panel:
        ...
        df = pl_in.bench_res.ds.to_dataframe()
    ...
    def dataframe_mean(self, pl_in: PlotInput) -> pn.panel:
        ...
        df = pl_in.bench_res.ds.mean("repeat").to_dataframe().reset_index()
    ...
    def xarray(self, pl_in: PlotInput) -> pn.panel:
        ...
        return pn.panel(pl_in.bench_res.ds, name=PlotTypes.xarray)
