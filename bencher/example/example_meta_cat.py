...
def example_meta_levels(
    ...
    bench.plot_sweep(
        ...
        description="This uses bencher to show how bencher plots sweeps of categorical variables of increasing dimensionality",
        input_vars=[BenchMeta.param.categorical_vars.with_sample_values([1, 2, 3])],
        const_vars=[
